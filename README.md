...
Displaying Results: Finally, it prints the totals using f-strings (f"..."), which allow us to plug our variables directly into the output text to match the required format.
